...
describe Mingle do
  context "authenticating" do
    ...
    it "should authenticate with the correct username" do
      ...
      Mingle.new(http_client, nil, nil, nil, "user", nil, nil)
    end
    ...
    it "should authenticate with the correct password" do
      ...
      Mingle.new(http_client, nil, nil, nil, nil, "password", nil)
    end
  end
  ...
  context "posting murmurs" do
    ...
    it "should posts to the correct url" do
      ...
      Mingle.new(@http_client, nil, nil, "the-project", nil, nil, nil).post_murmur(nil)
    end
